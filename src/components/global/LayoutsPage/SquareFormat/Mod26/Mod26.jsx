...
const Mod26 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod26SquareFormat-layout">
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod26);
