...
const Mod8 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod8SquareFormat-layout">
			<div
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod8);
