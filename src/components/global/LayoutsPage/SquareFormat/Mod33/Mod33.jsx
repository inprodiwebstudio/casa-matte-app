...
const Mod33 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod33SquareFormat-layout">
			<div className="content-body">
				<div
					className="content-children-second-body"
				>
					<div
						className="content-children-nested"
					...
					>
						{
							(images && images[1].url && isInWorkSpcae) && (
								<ActionImagesLayout sheetNo={sheetNo} layoutNo={1} pageId={pageId} image={selectPhotoUrl(images[2])} />
							)
						}
					</div>
					<div
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod33);
