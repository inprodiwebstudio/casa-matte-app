				...
				>
					{
						(images && images[4].url && isInWorkSpcae) && (
							<ActionImagesLayout sheetNo={sheetNo} layoutNo={4} pageId={pageId} image={selectPhotoUrl(images[4])} />
						)
					}
				</div>
				<div
				...
				>
					{
						(images && images[5].url && isInWorkSpcae) && (
							<ActionImagesLayout sheetNo={sheetNo} layoutNo={5} pageId={pageId} image={selectPhotoUrl(images[5])} />
						)
					}
				</div>
				<div
				...
				>
					{
						(images && images[6].url && isInWorkSpcae) && (
							<ActionImagesLayout sheetNo={sheetNo} layoutNo={6} pageId={pageId} image={selectPhotoUrl(images[6])} />
						)
					}
				</div>
				<div
				...
				>
					{
						(images && images[7].url && isInWorkSpcae) && (
							<ActionImagesLayout sheetNo={sheetNo} layoutNo={7} pageId={pageId} image={selectPhotoUrl(images[7])} />
						)
					}
				</div>
				<div
				...
				>
					{
						(images && images[8].url && isInWorkSpcae) && (
							<ActionImagesLayout sheetNo={sheetNo} layoutNo={8} pageId={pageId} image={selectPhotoUrl(images[8])} />
						)
					}
				</div>
			</div>
