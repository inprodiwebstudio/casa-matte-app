...
const Mod31 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod31SquareFormat-layout">
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod31);
