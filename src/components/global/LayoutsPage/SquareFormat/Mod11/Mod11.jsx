...
const Mod11 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod11SquareFormat-layout">
			<div
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod11);
