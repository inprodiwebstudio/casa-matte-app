...
const Mod20 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod20SquareFormat-layout">
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod20);
