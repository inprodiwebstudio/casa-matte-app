...
const Mod13 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod13SquareFormat-layout">
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod13);
