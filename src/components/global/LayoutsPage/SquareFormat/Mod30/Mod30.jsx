...
const Mod30 = ({images, sheetNo, workSpaceSlice, dragerImage, isInWorkSpcae}) => {
	...
	return (
		<div className="body-mod30SquareFormat-layout">
...
export default connect(mapStateToProps, mapDispatchToProps) (Mod30);
