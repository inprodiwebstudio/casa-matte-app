...
const Mod49Pdf = ({text}) => {
	...
	const text02 = text[2] ? text[2] : "<p style='text-align: left;'><span style='font-size: 34px; font-family: Aitana-Regular;'>FRANCIA</span></p>";

	const text03 = text[4] ? text[4] : "<p style='text-align: left;'><span style='font-size: 34px; font-family: Aitana-Regular;'>TURQUÍA</span></p>";

	const text04 = text[1] ? text[1] : "<p style='text-align: left;'><span style='font-size: 23px; font-family: Spectral-Light-Italic;'>Madrid</span></p><p style='text-align: left;'><span style='font-size: 23px; font-family: Spectral-Light-Italic;'>Segovia</span></p><p style='text-align: left;'><span style='font-size: 23px; font-family: Spectral-Light-Italic;'>Salamanca</span></p>";

	const text05 = text[3] ? text[3] : "<p style='text-align: left;'><span style='font-size: 23px; font-family: Spectral-Light-Italic;'>París</span></p><p style='text-align: left;'><span style='font-size: 23px; font-family: Spectral-Light-Italic;'>Versalles</span></p>";
