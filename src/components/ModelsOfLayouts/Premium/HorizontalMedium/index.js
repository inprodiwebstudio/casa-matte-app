...
const HorizontalMedium = {
	...
	Mod37 : {
		...
		presetNewText   : {
			text     : "<p style='text-align: center;'><span style='font-size: 30px; font-family: Aitana-Regular;'>Agregar texto...</span></p>",
			position : {
				x : 0,
				y : 0,
			},
	...
	Mod38 : {
		...
		defaultTexts : [
			...
			{
				text     : "<p style='text-align: right;'><span style='font-size: 12px; font-family: Inter-Lifght;'>SUBTÍTULO 1</span></p>",
				position : {
					x : 270.7304284520105,
					y : 537.4932254867878,
				},
	...
	Mod39 : {
		...
		presetNewText   : {
			text     : "<p style='text-align: left;'><span style='font-size: 18px; font-family: Aitana-Regular;'>Agregar texto...</span></p>",
			position : {
				x : 0,
				y : 0,
			},
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: left;'><span style='font-size: 18px; font-family: Aitana-Regular;'>ESPAÑA</span></p>",
				position : {
					x : 639.293212886966,
					y : 314.73020853655623,
				},
				sizes : {
					width  : "107px",
					height : "28px",
	...
	Mod40 : {
		...
		defaultTexts : [
			...
			},
			{
				text     : "<p style='text-align: left;'><span style='font-size: 12px; font-family: Spectral-Light-Italic;'>Madrid</span></p><p style='text-align: left;'><span style='font-size: 12px; font-family: Spectral-Light-Italic;'>Segovia</span></p><p style='text-align: left;'><span style='font-size: 12px; font-family: Spectral-Light-Italic;'>Salamanca</span></p>",
				position : {
					x : 350.87219077296504,
					y : 405.25652432603005,
				},
				sizes : {
					width  : "104px",
					height : "80px",
	...
	Mod41 : {
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: center;'><span style='font-size: 18px; font-family: Aitana-Regular;'>ESPAÑA</span></p>",
				position : {
					x : 78.24058130801905,
					y : 235.78284011550468,
				},
				sizes : {
					width  : "647px",
					height : "28px",
	...
	Mod42 : {
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: center;'><span style='font-size: 18px; font-family: JosefinSans-Light;'>Título pequeño 1</span></p>",
				position : {
					x : 71.92479183433483,
					y : 276.83542591808583,
				},
				sizes : {
					width  : "647px",
					height : "30px",
	...
	Mod45 : {
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: center;'><span style='font-size: 12px; font-family: Inter-Lifght;'>Odi pullerit. Actus nes consid fur, senatus, essendi enatrum pra, us consum, que quam, ve, quo potimorta trurs con hosus ore dumus ommorunum dium oporat, elum hocul verobu</span></p>",
				position : {
					x : 163.71427850638534,
					y : 272.7828656395717,
				},
				sizes : {
					width  : "471px",
	...
	Mod46 : {
		...
		presetNewText   : {
			text     : "<p style='text-align: right;'><span style='font-size: 12px; font-family: Inter-Lifght;'>Agregar texto...</span></p>",
			position : {
				x : 0,
				y : 0,
			},
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: right;'><span style='font-size: 12px; font-family: Inter-Lifght;'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua...</span></p>",
				position : {
					x : 393.08266215711427,
					y : 498.9407348523467,
				},
				sizes : {
					width  : "349px",
	...
	Mod47 : {
		...
		presetNewText   : {
			text     : "<p style='text-align: left;'><span style='font-size: 14px; font-family: JosefinSans-Light;'>Agregar texto...</span></p>",
			position : {
				x : 0,
				y : 0,
			},
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: left;'><span style='font-size: 14px; font-family: JosefinSans-Light;'>Subtítulo 3</span></p>",
				position : {
					x : 178.2405813080191,
					y : 113.67757695760992,
				},
				sizes : {
					width  : "382px",
					height : "25px",
	...
	Mod48 : {
		...
		defaultTexts : [
			{
				text     : "<p style='text-align: left;'><span style='font-size: 14px; font-family: JosefinSans-Light;'>EC</span></p>",
				position : {
					x : 86.66163393959778,
					y : 166.30915590497847,
				},
				sizes : {
					width  : "486px",
					height : "26px",
			...
			{
				text     : "<p style='text-align: justify;'><span style='font-size: 12px; font-family: JosefinSans-Light;'>Et maecenas ante viverra potenti libero purus habitasse aliquam, non massa vivamus dictumst eu erat sodales cursus, integer lacinia rutrum urna aliquet convallis scelerisque. Volutpat condimentum quis taciti fames tempor sagittis eleifend nostra donec, proin ad dis nec sollicitudin dictum viverra semper ridiculus, potenti feugiat odio tellus nisl curabitur nunc phasellus. Luctus iaculis suscipit inceptos mollis quisque nam cum turpis cras, class ante risus ultricies dapibus justo suspendisse enim, cubilia feugiat sed est dui lacinia diam vivamus.</span></p>",
				position : {
					x : 86.66169575556299,
					y : 209.46705175182498,
				},
				sizes : {
					width  : "304px",
					height : "190px",
	...
	Mod49 : {
		...
		defaultTexts : [
			...
			},
			{
				text     : "<p style='text-align: justify;'><span style='font-size: 12px; font-family: JosefinSans-Light;'>Lorem ipsum dolor sit amet consectetur adipiscing elit, nascetur feugiat natoque vel nisi est, lacinia in sociis sodales luctus integer. Lectus conubia libero proin tempus molestie feugiat posuere ullamcorper placerat fringilla, litora consequat torquent habitasse commodo inceptos lobortis velit vulputate, magna natoque integer euismod suscipit gravida scelerisque cras aliquet. Tincidunt velit viverra dignissim ridiculus taciti rhoncus nibh senectus semper, pharetra odio conubia dictumst malesuada lectus dis penatibus, primis orci dictum sociosqu nam platea parturient cursus.</span></p>",
				position : {
					x : 422.87218466614854,
					y : 357.15124818829713,
				},
				sizes : {
					width  : "315px",
					height : "203px",
		...
		linesDecoration : [
			{
				...
				weight      : "1px",
				position    : {
					x : 425.07602339180994,
					y : 326.31578947368433,
				},
			},
		],
	},
